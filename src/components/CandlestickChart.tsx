...
export function CandlestickChart({
  ...
  return (
    <div className="relative">
      ...
      >
        {/* Background grid */}
        <line x1="0" y1="25" x2="100" y2="25" stroke="currentColor" strokeWidth="0.1" className="text-border opacity-30" strokeDasharray="1,1" />
        <line x1="0" y1="50" x2="100" y2="50" stroke="currentColor" strokeWidth="0.1" className="text-border opacity-30" strokeDasharray="1,1" />
        <line x1="0" y1="75" x2="100" y2="75" stroke="currentColor" strokeWidth="0.1" className="text-border opacity-30" strokeDasharray="1,1" />
        ...
        {candles.map((candle, index) => {
          ...
          const isPriorCandle = patientCandle && index === patientCandle.priorCandleIndex;
          const isPCCandle = patientCandle && index === patientCandle.pcCandleIndex;
