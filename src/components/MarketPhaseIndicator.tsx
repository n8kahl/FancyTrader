...
export function MarketPhaseIndicator({ marketPhase: propMarketPhase, dayType, event }: MarketPhaseIndicatorProps) {
    ...
    switch (marketPhase.phase) {
      ...
      case "ORB_FORMING":
        return {
          ...
          icon: Activity,
          description: "Opening Range Breakout forming. King & Queen setups available after 09:40 ET.",
        };
      case "POST_10":
        return {
          ...
          icon: TrendingUp,
          description: "VWAP strategies now active. All setups available. 10m trend clarity on SPX after 11:00 ET.",
        };
      case "CLOUD_WINDOW":
        return {
          label: "Cloud Window",
          ...
          icon: Activity,
          description: "Cloud Strategy window (13:00-15:00 ET). Prefer if morning trended. Algos around 12:55 ET.",
        };
      case "CLOSE":
        return {
    ...
    <div className="flex flex-wrap items-center gap-2">
      ...
      {event && (
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              <Badge variant="outline" className="bg-red-500/10 text-red-500 border-red-500/20 cursor-help animate-pulse">
