...
*These suggestions align with the LTP philosophy: teach the system through the UI, enforce discipline, and make high-probability setups obvious while filtering noise.*
