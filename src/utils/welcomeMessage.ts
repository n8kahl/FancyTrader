...
export function displayWelcomeMessage() {
  ...
  console.log('%c   1. Open terminal and run: %ccd backend && npm run dev', styles.text, styles.code);
  ...
  console.log('%c   Toggle between mock and live data anytime with the "Mock"/"Go Live" button', styles.text);
  console.log('');
}
