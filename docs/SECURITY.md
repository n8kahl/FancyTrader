...
- **CORS & WS origins** – both HTTP and WS guards use the shared `CORS_ALLOWLIST`; Vercel preview deploys (`https://fancy-trader-*.vercel.app`) are permitted automatically.
