 ...
 */
export function isRSIOversold(rsi: number, threshold = 30): boolean {
 ...
 */
export function isRSIOverbought(rsi: number, threshold = 70): boolean {
  return rsi > threshold;
}
 ...
 */
export function isPatientCandle(bar: Bar, atr: number, threshold = 0.5): boolean {
