...
```typescript
// Change these lines:
const PRODUCTION_HTTP_URL =
  (import.meta.env?.VITE_BACKEND_URL as string) || "https://YOUR-ACTUAL-RAILWAY-URL.up.railway.app";
const PRODUCTION_WS_URL =
  (import.meta.env?.VITE_BACKEND_WS_URL as string) ||
  "wss://YOUR-ACTUAL-RAILWAY-URL.up.railway.app/ws";
```
