...
import { Terminal, CheckCircle2, ExternalLink, Server, Wifi, Copy, Check } from "lucide-react";
    ...
    <Card className="p-6 border-blue-500/20 bg-blue-500/5">
      <div className="space-y-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <AlertDescription className="text-sm text-muted-foreground mb-4">
              The app is currently in <strong>mock data mode</strong>. To connect to live market
              data, start the backend server.
            </AlertDescription>
          </div>
        </div>
        ...
        <div className="space-y-3 ml-8">
          <div>
            ...
            <div className="bg-muted/50 p-3 rounded-md font-mono text-xs flex items-center justify-between group">
              ...
              <Button
                ...
                onClick={() => void copyCommand("cd backend", 1)}
              >
          ...
          <div>
            ...
            <div className="bg-muted/50 p-3 rounded-md font-mono text-xs flex items-center justify-between group">
              ...
              <Button
                ...
                size="sm"
                className="h-6 w-6 p-0 opacity-0 group-hover:opacity-100 transition-opacity"
                onClick={() => void copyCommand("npm run dev", 4)}
              >
          ...
          <div>
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              Click the <strong className="text-foreground mx-1">&ldquo;Go Live&rdquo;</strong> button in the
              header
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 pt-4 border-t">
          <Button variant="default" size="sm" onClick={onSwitchToMock}>
