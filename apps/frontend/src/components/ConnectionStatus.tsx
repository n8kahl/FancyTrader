...
import { Wifi, WifiOff, RefreshCw, CheckCircle2, XCircle, Activity } from "lucide-react";
import {
  getConnectionInfo,
  runConnectionTests,
  logTestResults,
...
import type { Snapshot, TradeLite, ServerOutbound } from "@fancytrader/shared";
...
export function ConnectionStatus({
  ...
  type ConnectionInfo = Awaited<ReturnType<typeof getConnectionInfo>>;
  type DiagnosticsConnectionInfo = ConnectionInfo & {
    lastSnapshot?: Snapshot | null;
    recentTrades?: TradeLite[];
    lastServerEvent?: ServerOutbound | null;
  };
  const [connectionInfo, setConnectionInfo] = useState<DiagnosticsConnectionInfo | null>(null);
              ...
              {connectionInfo && (
                <>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="outline">{connectionInfo.environment}</Badge>
                  </div>
