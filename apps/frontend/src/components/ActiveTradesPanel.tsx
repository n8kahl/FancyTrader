...
type ActiveTrade = Trade & TradeLite;

interface ActiveTradesPanelProps {
  trades: ActiveTrade[];
  onViewDetails: (trade: ActiveTrade) => void;
  onManageTrade: (trade: ActiveTrade) => void;
}
              ...
              >
                ...
                {trade.position && trade.tradeState !== "LOADED" ? (
                  ...
                  <div className="flex items-center gap-1 text-xs text-muted-foreground">
                    ...
                    <span>
                      Loaded @ $
                      {trade.optionsContract?.premium !== undefined
                        ? trade.optionsContract.premium.toFixed(2)
                        : "0.00"}
                    </span>
                  </div>
                )}
